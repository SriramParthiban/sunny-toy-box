...
const heroSlides = [
  ...
  },
  {
    ...
    title: <>Festival of Toys<br /><span className="text-secondary">Flat 50% OFF</span> 🎇</>,
    desc: 'Light up your kids\' Diwali with amazing toys! Extra ₹200 off with code DIWALI200.',
    cta: 'Shop Diwali Sale',
    link: '/products?tag=trending',
    bg: 'from-[hsl(25,90%,45%)] to-[hsl(45,100%,51%)]',
    textColor: 'text-primary-foreground',
    floatEmoji: '🪔',
    wiggleEmoji: '🎆',
  },
  {
    badge: '🎄 Christmas Joy',
    title: <>Santa's Toy Shop<br /><span className="text-secondary">Is Here!</span> 🎅</>,
    desc: 'Ho ho ho! Find the perfect Christmas gifts. Free Santa gift bag on orders above ₹1499.',
    cta: 'Shop Christmas',
    link: '/products',
    bg: 'from-[hsl(140,60%,30%)] to-[hsl(0,70%,45%)]',
    textColor: 'text-primary-foreground',
    floatEmoji: '🎄',
    wiggleEmoji: '🎅',
  },
  {
    badge: '☀️ Summer Sale',
    title: <>Beat The Heat<br />With <span className="text-secondary">Cool Toys!</span> 🏖️</>,
    desc: 'Water guns, outdoor games & more! Up to 55% off on summer favorites. Limited stock!',
    cta: 'Shop Summer',
    link: '/products?search=outdoor',
    bg: 'from-[hsl(195,90%,45%)] to-[hsl(170,70%,40%)]',
    textColor: 'text-primary-foreground',
    floatEmoji: '🏖️',
    wiggleEmoji: '🌊',
  },
